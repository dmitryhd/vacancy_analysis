...
def create_fictive_database():
    ...
    raw_vacs = [
        dm.RawVacancy(
            '1', ('<td class="l-content-colum-1 b-v-info-content">'
                  'java c++ от 10 000 до 15 000 </td>')),
        dm.RawVacancy(
            '2', ('<td class="l-content-colum-1 b-v-info-content">'
                  'c++ от 11 000 до 16 000 </td>')),
        dm.RawVacancy(
            '3', ('<td class="l-content-colum-1 b-v-info-content">'
                  'c++ от 9 000 до 14 000 </td>')),
        dm.RawVacancy(
            '4', ('<td class="l-content-colum-1 b-v-info-content">'
                  'python от 15 000 </td>'))
    ]
    raw_vac_session.add_all(raw_vacs)
    raw_vac_session.commit()
    proc_vacs = vacan.processor.vacancy_processor.process_vacancies_from_db(
        raw_vac_session, skills.SKILLS)
